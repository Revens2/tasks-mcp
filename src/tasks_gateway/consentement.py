"""Page de consentement du flux OAuth de la passerelle tasks.
...
from tasks_gateway.oauth import (
    PORTEE,
    PORTEE_ECRITURE,
    FournisseurOAuth,
    verifier_phrase,
...
VARIABLE_EMPREINTE = "TASKS_MCP_CONSENT_HASH"

_GABARIT = """<!doctype html>
<html lang="fr"><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Autoriser l'acces a tâches et rappels</title>
<style>
...
<h1>Autoriser l'acces a vos tâches et rappels</h1>
...
_LIBELLES = {
    PORTEE: ("Lire", "vos tâches et rappels (listes, evenements, disponibilites)"),
    PORTEE_ECRITURE: ("Creer et modifier", "des evenements dans vos tâches et rappels"),
}
